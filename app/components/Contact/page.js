...
const Contact = () => {
  ...
  <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
    ...
    <div class="h-full lg:w-1/3 md:w-1/2 bg-gradient-to-r from-purple-500 to-pink-500 flex flex-col md:ml-auto w-full py-6 px-6 mt-8 md:mt-0">
      <h2 class="text-white text-lg mb-1 font-medium title-font">Contact Us</h2>
      <p class="leading-relaxed mb-5 text-white">Let"s discuss the project.</p>
      ...
      <button class=" bg-purple-900 text-white border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded text-lg">Send</button>
